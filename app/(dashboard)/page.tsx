...
async function getDashboardData() {
  ...
  const [
    ...
    prisma.job.findMany({
      where: { scheduledAt: { gte: subMonths(now, 0) } },
      include: {
    ...
    <div className="space-y-6 py-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          subtitle={`${stats.overdueUnits} overdue`}
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass-card p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/assets" className="text-xs text-green-400 hover:text-green-300 transition-colors">
              Full Map →
            </a>
          </div>
        ...
        <div className="touch-scroll">
          <table className="w-full text-xs min-w-[600px]">
            ...
            <tbody>
              ...
              {recentJobs.length === 0 && (
                <tr>
                  <td colSpan={6} className="py-8 text-center text-mint-muted">No jobs yet</td>
                </tr>
              )}
            </tbody>
          </table>
